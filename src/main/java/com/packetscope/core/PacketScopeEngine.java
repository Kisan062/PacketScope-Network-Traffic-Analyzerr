...
import com.packetscope.parser.PacketParser;
import com.packetscope.parser.PcapReader;
import com.packetscope.rules.RuleManager;
import com.packetscope.sni.AppClassifier;
import com.packetscope.sni.HTTPHostExtractor;
import com.packetscope.sni.SNIExtractor;
...
public class PacketScopeEngine {
    ...
    public PacketScopeEngine(int workerThreads, RuleManager ruleManager, AlertEngine alertEngine) {
    ...
    private void processPacket(byte[] raw) {
        ...
        // PacketScope — SNI / HTTP Host extraction
